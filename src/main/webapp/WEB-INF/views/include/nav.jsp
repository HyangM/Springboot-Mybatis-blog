...
<body>
	...
	<nav class="navbar navbar-expand-md bg-warning navbar-light">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			...
			<img src="/media/${sessionScope.principal.profile}"class="rounded-circle my__img ml-auto"width="40px"height="40px"onerror="javascript:this.src='/images/unknown.jpg'"/>
		</div>
	</nav>
	<br />